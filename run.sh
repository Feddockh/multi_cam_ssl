...
if [ "$MODE" == "train" ]; then
    ...
    python fbdetr/main.py --batch_size 2 --no_aux_loss --eval --resume https://dl.fbaipublicfiles.com/detr/detr-r50-e632da11.pth --coco_path erwiam_dataset --dataset_file fire_blight
elif [ "$MODE" == "vis" ]; then
