...
img_path = 'images/fire_blight3.jpg'
name_list = ['healthy buds', 'shriveled buds',
             'healthy shoots', 'shriveled shoots',
             'healthy branches',
             'healthy leaves', 'dead leaves',
             'grass', 'sky', 'ground', 'tree']
# name_list = ['cracked bark', 'healthy bark', 'ground']


#SAM　settings
sam_checkpoint = "/home/hayden/cmu/kantor_lab/multi_cam_ssl/Trident/segment_anything/sam_vit_b_01ec64.pth"
model_type = "vit_b"
device = "cuda"
coarse_thresh = 0.2
